...
<section class="mb-4">
  ...
  <div > <h1 class="text-center"  id= purple-myname style="padding-top: 20px; padding-bottom: 20px; padding-right: 20px; font-family: sans-serif -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; border-bottom:solid 2px;"   >Book Me</h1></div>


  <!--Section heading-->
  <h2 class="h1-responsive font-weight-bold text-center my-4"></h2>
  <!--Section description-->
  <p  id= purple-myname class="text-center w-responsive  mx-auto mb-5">Do you want to book a session? Please do not hesitate to contact me directly. I will come back to you within
